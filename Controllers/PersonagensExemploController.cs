...
namespace RpgApi.Controllers
{
    ...
    public class PersonagensExemploController : ControllerBase
    {
        ...
        //Buscando dados do personagem GetFirst() → retorna o primeiro Get() → retorna todos  GetSingle(id) → retorna um pelo ID
    ...
    public IActionResult Deletar(int Id)
        ...
        [HttpPut]
        public IActionResult UpdataPersonagem(Personagem p)
        {
